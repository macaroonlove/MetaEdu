...
public class RoomPuller : MonoBehaviourPunCallbacks
{
    ...
    public void CreateRoom()
    {
        ...
        client = null;
        callback = null;
        RoomChangeManager.Instance.RoomOut((roomName.text.Equals("") ? PhotonNetwork.LocalPlayer.NickName + "님의 방" : roomName.text) + "#" + _roomSet + "#" + UtilClass.GenerateToken(10), roomMax.value + 2, 1, roomTitle.text);
    }
}