    ...
    public class RebindActionUI : MonoBehaviour
    {
        ...
        private void PerformInteractiveRebind(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            else if (act.Equals("Move"))
            {
                ...
                else if (acn.Equals("down")) partName = "뒤로으로 이동";
                else if (acn.Equals("left")) partName = "왼쪽으로 이동";
                else if (acn.Equals("right")) partName = "오른쪽으로 이동";
            }
            else if (act.Equals("Eyesight"))
            {
                if (acn.Equals("positive")) partName = "1인칭 시점 변환";
                else if (acn.Equals("negative")) partName = "3인칭 시점 변환";
            }
        ...
        private bool CheckDuplicateBindings(InputAction action, int bindingIndex, bool allCompositeParts = false)
        {
            ...
            for (int i = 0; i < action.actionMap.bindings.Count; i++)
            {
                ...
                {
                    if(!newBinding.action.Equals("Move") && !newBinding.action.Equals("Eyesight"))
                        continue;
                    else
                    {
